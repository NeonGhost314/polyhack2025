      ...
      <div className="relative z-30 flex items-center justify-center min-h-screen">
        <form className="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg max-w-lg w-full mx-4">
          ...
          <div className="mb-4">
            ...
            <input type="text" id="name" name="name" placeholder="Your name" className="mt-1 w-full p-2 border rounded-md"/>
          </div>
          <div className="mb-4">
            <label htmlFor="email" className="block text-gray-700">Email :</label>
            <input type="email" id="email" name="email" placeholder="Your email" className="mt-1 w-full p-2 border rounded-md"/>
          </div>
          <div className="mb-4">
            <label htmlFor="message" className="block text-gray-700">Message :</label>
            <textarea id="message" name="message" rows={5} placeholder="Message" className="mt-1 w-full p-2 border rounded-md resize-none"></textarea>
          </div>
